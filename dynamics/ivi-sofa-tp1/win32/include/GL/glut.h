...
extern  		"C" {
	...
	**/ 
	...
	extern int APIENTRY			glutCreateSubWindow(int win, int x, int y,
	...
	extern void APIENTRY		glutChangeToMenuEntry(int item,
													  const char* label,
													  int value);
	...
	extern void APIENTRY		glutChangeToSubMenu(int item,
													const char* label,
													int submenu);
	...
	extern void APIENTRY		glutTimerFunc(unsigned int millis,
											  void (*func) (int value),
											  int value);
	...
	extern void APIENTRY		glutJoystickFunc(void (*func) (unsigned int buttonMask, int x, int y, int z),
												 int pollInterval);
	...
	#if (GLUT_API_VERSION >= 4 || GLUT_XLIB_IMPLEMENTATION >= 9)
	extern int APIENTRY			glutBitmapLength(void* font,
	...
	extern int APIENTRY			glutStrokeLength(void* font,
												 const unsigned char* string);
	...
	extern void APIENTRY		glutWireCone(GLdouble base, GLdouble height,
	...
	extern void APIENTRY		glutSolidCone(GLdouble base, GLdouble height,
											  GLint slices, GLint stacks);
	...
	extern void APIENTRY		glutWireTorus(GLdouble innerRadius,
	...
	extern void APIENTRY		glutSolidTorus(GLdouble innerRadius,
											   GLdouble outerRadius,
											   GLint sides, GLint rings);
	...
	extern void APIENTRY		glutVideoResize(int x, int y, int width,
												int height);
	...
	extern void APIENTRY		glutVideoPan(int x, int y, int width,
											 int height);
