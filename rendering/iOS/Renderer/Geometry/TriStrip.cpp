...
/*!***************************************************************************
 @Function			TriStripList
 @Modified			pwTriList
 @Input				nTriCnt
 @Description
 Reads a triangle list and generates an optimised triangle strip. Result is
 converted back to a triangle list.
*****************************************************************************/
void TriStripList(
	unsigned short		* const pwTriList,
	const unsigned int	nTriCnt)
{
	unsigned short	*pwStrips;
	...
	/*
		Strip the geometry
	*/
	TriStrip(&pwStrips, &pnStripLength, &nNumStrips, pwTriList, nTriCnt);
