...
/*
static const float fat_triangle[]=
{
	-6.158554,-0.000000,-0.000925,   0.5f,	0,  1,0,	0,1,
	-0.028798,-0.000000,-0.000925,   0.5f,	0,  1,0,	0,1,
	-6.158554,-0.000000,-6.130690,   0.5f,	0,  1,0,	0,1	
};


static const int fat_triangle_indices[]=
{
	0,1,2,3,4,5
};
...
static const float fat_triangle[]=
{
	-10.f, -10,  -0.05,  0.5f,	0,  1,0,	0,0,
	-10.f,   0,  -0.05,  0.5f,	0,  1,0,	1,0,
	10.f,   0,   -0.05,  0.5f,	0,  1,0,	1,1,
	-10.f, -10,   0.05,  0.5f,	0,  1,0,	0,1,
	-10.f,   0,   0.05,  0.5f,	0,  1,0,	0,1,
	10.f,   0,    0.05,  0.5f,	0,  1,0,	0,0
};
*/
#if 0
static const float triangle_vertices[] =
{
	-1.f,	-0.15,  -1.f,  0.5f,	0,  1,0,	0,0,
	-1.f,	-0.15,	1.f,   0.5f,	0,  1,0,	1,0,
	1.f,	-0.15,  1.f,   0.5f,	0,	1,0,	1,1,
	-1.f,	0.15,  -1.f,  0.5f,	0,  1,0,	0,0,
	-1.f,	0.15,	1.f,   0.5f,	0,  1,0,	1,0,
	1.f,	0.15,  1.f,   0.5f,	0,	1,0,	1,1,
