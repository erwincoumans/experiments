...
#ifndef BT_PGS_CONSTRAINT_SOLVER_H
#define BT_PGS_CONSTRAINT_SOLVER_H

//#define BT_SUPPORT__NON_CONTACT_CONSTRAINTS
...
///The btPgsSolver is a fast SIMD implementation of the Projected Gauss Seidel (iterative LCP) method.
ATTRIBUTE_ALIGNED16(class) btPgsSolver : public btConstraintSolver
{
protected:
...
typedef btPgsSolver btPgsSolverPrefered;
#endif


#endif //BT_PGS_CONSTRAINT_SOLVER_H
